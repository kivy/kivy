...
sudo apt -y install libgstreamer1.0-dev gstreamer1.0-alsa gstreamer1.0-plugins-base;
sudo apt -y install python3 python3-dev libsmpeg-dev libswscale-dev libavformat-dev libavcodec-dev libjpeg-dev libtiff4-dev libX11-dev libmtdev-dev;
sudo apt -y install python3-setuptools build-essential libgl1-mesa-dev libgles2-mesa-dev;
sudo apt -y install xvfb pulseaudio xsel;
