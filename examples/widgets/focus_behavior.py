...
class FocusLabel(FocusWithColor, Label):
    ...
    def keyboard_on_key_down(self, window, keycode, text, modifiers):
        ...
        """
        if super(FocusLabel, self).keyboard_on_key_down(
...
class FocusApp(App):
    def build(self):
        ...
        self.grid1 = grid1 = FocusGridLayout(
            cols=4, padding=[10, 10], spacing=10
        )
        self.grid2 = grid2 = FocusGridLayout(
            cols=4, padding=[10, 10], spacing=10
        )
        ...
        grid2.children[30].text = grid1.children[14].text = grid2.children[
            15
        ].text = grid1.children[34].text = "Skip me"
