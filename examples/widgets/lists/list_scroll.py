...
# (Just so you know, the next line is very long, with the girl name data, in
#  case it flakes out your editor).
...
class ScrollTestApp(App):
    ...
    def __init__(self, **kwargs):
        ...
        self.us_baby_girl_names_controller = \
                ListController(
                    data=[GirlNameDataItem(text=g) for g in girl_names_2012_usa],
