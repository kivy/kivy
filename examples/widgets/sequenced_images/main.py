...
class mainclass(FloatLayout):
    ...
    def __init__(self, **kwargs):
        ...
        left_frame = GridLayout(size_hint=(0.25, 1), cols=1)
        ...
        but_load_zip_png = AnimatedButton(
            text="load zipped\n png/s", halign="center"
        )
        but_load_zip_jpg = AnimatedButton(
            text="load zipped\n jpg/s", halign="center"
        )
        but_animated = AnimatedButton(
        ...
        but_animated_normal.border = but_animated_borderless.border = (
            0,
            0,
            0,
            0,
