...
_clipboards = []
if platform == "android":
    _clipboards.append(("android", "clipboard_android", "ClipboardAndroid"))
elif platform == "macosx":
    _clipboards.append(("nspaste", "clipboard_nspaste", "ClipboardNSPaste"))
elif platform == "win":
    _clipboards.append(("winctypes", "clipboard_winctypes", "ClipboardWindows"))
elif platform == "linux":
...
if platform == "linux":
    ...
    if Clipboard.__class__.__name__ in (c[2] for c in _cutbuffers):
        ...
        CutBuffer = core_select_lib(
            "cutbuffer", _cutbuffers, True, basemodule="clipboard"
        )
