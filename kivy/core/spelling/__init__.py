...
class SpellingBase(object):
    ...
    def select_language(self, language):
        ...
        raise NotImplementedError(
            "select_language() method not implemented "
    ...
    def list_languages(self):
        ...
        """
        raise NotImplementedError(
            "list_languages() is not implemented "
            "by abstract spelling base class!"
        )
    ...
    def check(self, word):
        ...
        """
        raise NotImplementedError(
            "check() not implemented by abstract " + "spelling base class!"
        )
    ...
    def suggest(self, fragment):
        ...
        """
        raise NotImplementedError(
            "suggest() not implemented by abstract " + "spelling base class!"
        )
