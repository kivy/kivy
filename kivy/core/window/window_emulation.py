'''
Window Emulation: virtual windowing provider which is used together
with screen module to emulate device real size screen.
In fact it uses one of available windowing providers
but also add layer for scaling viewport
'''

__all__ = ('WindowEmulation', )
