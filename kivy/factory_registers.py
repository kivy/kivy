...
r('HoverBehavior', module='kivy.uix.behaviors.hover')
r('HoverCollideBehavior', module='kivy.uix.behaviors.hover')
...
r('SvgWidget', module='kivy.uix.svg')
r('AsyncSvgWidget', module='kivy.uix.svg')
r('LottieWidget', module='kivy.uix.lottie')
...
r('SelectableBodyTextInput', module='kivy.uix.selectable_html')
r('SelectableMarkupLabel', module='kivy.uix.selectable_html')
r('SelectableHtmlLabel', module='kivy.uix.selectable_html')
