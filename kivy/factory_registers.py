...
r = Factory.register
r('Adapter', module='kivy.adapter')
r('Controller', module='kivy.controllers.controller')
r('ListController', module='kivy.controllers.listcontroller')
r('ObjectController', module='kivy.controllers.objectcontroller')
r('TransformController', module='kivy.controllers.transformcontroller')
r('SelectableDataItem', module='kivy.models')
...
r('TransformProperty', module='kivy.properties')
r('FilterProperty', module='kivy.properties')
r('MapProperty', module='kivy.properties')
r('NumericProperty', module='kivy.properties')
...
r('ObjectView', module='kivy.uix.objectview')
...
r('Binding', module='kivy.binding')
r('DataBinding', module='kivy.binding')
r('SelectionBinding', module='kivy.binding')
