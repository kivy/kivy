...
r('RecycleViewBehavior', module='kivy.uix.recycleview')
r('RecycleView', module='kivy.uix.recycleview')
r('LayoutSelectionMixIn', module='kivy.uix.recycleview.layout')
...
r('RecycleLayout', module='kivy.uix.layout')
r('RecycleGridLayout', module='kivy.uix.gridlayout')
