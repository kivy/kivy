...
IF USE_OPENGL_ES2:
    ...
    GL_MAX_FRAGMENT_UNIFORM_VECTORS = cgldef.GL_MAX_FRAGMENT_UNIFORM_VECTORS
    GL_IMPLEMENTATION_COLOR_READ_TYPE = cgldef.GL_IMPLEMENTATION_COLOR_READ_TYPE
    GL_IMPLEMENTATION_COLOR_READ_FORMAT = cgldef.GL_IMPLEMENTATION_COLOR_READ_FORMAT
    GL_SHADER_COMPILER = cgldef.GL_SHADER_COMPILER
    GL_NUM_SHADER_BINARY_FORMATS = cgldef.GL_NUM_SHADER_BINARY_FORMATS
    GL_LOW_FLOAT = cgldef.GL_LOW_FLOAT
    GL_MEDIUM_FLOAT = cgldef.GL_MEDIUM_FLOAT
    GL_HIGH_FLOAT = cgldef.GL_HIGH_FLOAT
    GL_LOW_INT = cgldef.GL_LOW_INT
    GL_MEDIUM_INT = cgldef.GL_MEDIUM_INT
    GL_HIGH_INT = cgldef.GL_HIGH_INT
    # update sizes
