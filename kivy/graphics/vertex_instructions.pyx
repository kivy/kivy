...
cdef class Mesh(VertexInstruction):
    ...
    cdef int set_vertices(self, vertices):
        if vertices is None or not len(vertices):
            ...
            self._vertices, self._fvertices = _ensure_float_view(vertices,
                &self._pvertices)
