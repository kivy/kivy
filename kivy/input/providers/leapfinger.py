...
on the fingers position within the Leap Interaction box.
'''
    ...
    def start(self):
        ...
        class LeapMotionListener(Leap.Listener):
            ...
            def on_init(self, controller):
                Logger.info('leapfinger: Initialized')

            def on_connect(self, controller):
                Logger.info('leapfinger: Connected')

            def on_disconnect(self, controller):
                Logger.info('leapfinger: Disconnected')
