...
class MultistrokeTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.Tinvar = MultistrokeGesture(
            "T", [TGesture], orientation_sensitive=False
        )
        self.Tbound = MultistrokeGesture(
            "T", [TGesture], orientation_sensitive=True
        )
        self.Ninvar = MultistrokeGesture(
            "N", [NGesture], orientation_sensitive=False
        )
        self.Nbound = MultistrokeGesture(
            "N", [NGesture], orientation_sensitive=True
        )
    ...
    def test_priority_sorting(self):
        ...
        r = gdb.recognize(
            [Ncandidate], goodscore=0.01, max_gpf=0, force_priority_sort=True
        )
        self.assertEqual(r.best["name"], "T")

        r = gdb.recognize(
            [Ncandidate], goodscore=0.01, force_priority_sort=False, max_gpf=0
        )
