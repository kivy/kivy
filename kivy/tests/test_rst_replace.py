...
class RstSubstitutionTestCase(GraphicUnitTest):
    ...
    #    # 4  0x00007ffff5d5ae15 in __pyx_f_4kivy_8graphics_3vbo_11VertexBatch_draw (__pyx_v_self=0x7fffed641390) at kivy/graphics/vbo.c:6529
    # On OSX:
    #  * thread #1, queue = 'com.apple.main-thread', stop reason = EXC_BAD_ACCESS (code=1, address=0x0)
    #  * frame #0: 0x00007fff555d9d42 GLEngine`gleRunVertexSubmitImmediate + 1234
    #    frame #1: 0x00007fff554c1544 GLEngine`glDrawElements_Exec + 563
    #    frame #2: 0x000000010429d273 vbo.cpython-36m-darwin.so`__pyx_f_4kivy_8graphics_3vbo_11VertexBatch_draw(__pyx_v_self=0x000000010cf344f8) at vbo.c:6575 [opt]
