...
cdef void  glReadnPixels (cgl.GLint x, cgl.GLint y, cgl.GLsizei width, cgl.GLsizei height, cgl.GLenum format, cgl.GLenum type, cgl.GLsizei buffer_size, cgl.GLvoid* buffer)
