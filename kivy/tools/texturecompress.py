...
class Tool(object):
    ...
    def run():
        ...
        parser.add_argument(
            "--mipmap", type=bool, default=False, help="Auto generate mipmaps"
        )
        parser.add_argument(
            "--dir",
            type=str,
...
class Etc1Tool(Tool):
    ...
    def locate_etc1tool(self):
        ...
        if self.etc1tool is None:
            print(
                'Error: Unable to locate "etc1tool".\n'
...
class PvrtcTool(Tool):
    ...
    def locate_texturetool(self):
        ...
        print(
            'Error: Unable to locate "texturetool".\n'
    ...
    def compress(self):
        ...
        # 5. write texture info
        self.write_tex(
            data, "pvrtc_rgba4", (w, h), (s2, s2), self.options.mipmap
        )
