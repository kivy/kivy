...
# macOS SDL3_mixer
MACOS__SDL3_MIXER__VERSION="3.1.2"
MACOS__SDL3_MIXER__URL="https://github.com/libsdl-org/SDL_mixer/releases/download/prerelease-$MACOS__SDL3_MIXER__VERSION/SDL3_mixer-$MACOS__SDL3_MIXER__VERSION.tar.gz"
